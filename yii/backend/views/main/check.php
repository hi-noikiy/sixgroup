...
<!--														<th class="hidden-480">用户头像</th>-->
												...
												<tbody>
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" name="ids" class="ace" value="<?php echo $room['r_id']?>"/>
																<span class="lbl"></span>
															</label>
														</td>
...
<!--														</td>-->
														<td><?php echo $room['r_area']?></td>
														<td><?php echo $room['r_pattem']?></td>
														<td><?php echo $room['r_price']?></td>
														<td><?php echo $room['r_people']?></td>
														</div>
