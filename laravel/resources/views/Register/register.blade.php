...
<div class="hd-wrap-fluid ">
    <div class="m-hd">
        <div class="site-logo-cont">
            <img  height="45px" width="100px" src="images/logo1.png" alt="蜗牛logo">

        </div>
        <div class="nav-list">
            <ul>
                <li class="first"><a href="http://www.tujia.com/" class="home-link " target="_blank">首页</a></li>
        ...
        <div class="column-wrap">
            ...
            <div class="main-box">
                ...
                <div class="my-form-wrap">
                    <form action="{{URL('register/add')}}" autocomplete="off" id="registerForm" method="post"><input id="RefUrl" name="RefUrl" type="hidden" value="http://www.tujia.com/beijing_gongyu/chaoyangqu_3581.htm" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input id="btnGetVerifyCode" type="button" onclick="lick()" value="获取手机验证码" class="verify-code-btn" />
...
<script>
    function lick(){
        ...
        var yz=Math.floor(Math.random()*10);
        var content='0';
        var url='http://api.k780.com:88/?app=sms.set_template&content='+content+'&appkey=18342&sign=54dde18295f570014b9f0486d16f1c2b';
