                    ...
                    <table class="order-table">
                        ...
                        <tr class="first">
                            <td rowspan="2" class="pic-box">
                                ...
                                <a href="{{URL('good')}}" target="_blank"><img src="../public/uploads/{{$img[0]}}" alt="" width="70" height="55" /></a>
                            </td>
                            <td colspan="4">
                        ...
                        <tr>
                            <td>
                                <p class="p-item">发布时间：<span class="date-box">{{$v->r_checkin}}</span></p>
                                <p class="p-item">房源格局：<span class="date-box">{{$v->r_pattem}}</span></p>
                            </td>
                            <td>
                                <p class="p-item">退房时间：<span class="date-box">{{$v->r_checkout}}</span></p>
                                <p class="p-item">可住人数：<span class="date-box">{{$v->r_people}}</span></p>
                            </td>
                            <td>
                                <p class="p-item">房屋价格：<span class="price-box"><dfn class="">¥</dfn>{{$v->r_price}}</span><span class="divItem">
                                        @if($v->state==1)
                                            审核
                                        @else
                                            未审核
                                ...
                                <span>
                                    <p class="p-item">房源地标：<span class="date-box">{{$v->r_coordinate}}</span></p>
                                </span>
