...
<script type="text/javascript">
    var staticFileRoot = "http://staticfile.tujia.com",
            minDate = "2016-05-22",
            mindate =  new Date(2016,4,22),
            maxDate = "2016-11-18",
            maxdate= new Date(2016,10,18),
            houseId,
            ServerDomain = "tujia.com",
            TUJIA_CLIENTID = '8c055550-124b-41a3-84b5-08481ddcacfc';
