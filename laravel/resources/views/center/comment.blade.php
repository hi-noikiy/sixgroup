...
<div  class="container_24">
    <div class="grid_24" id="dir"><a href="http://localhost/web/snail/laravel/public/">蜗牛短租</a><em>&gt;</em>我要评论</div>
</div>
    ...
    <div class="grid_19" id="order">
                            ...
                            <li class="myfavorite" unitid="17082" unittype="0">
                                ...
                                <div class="house-info">
                                    <p class="house-datelist">
                                        <span title="独栋别墅 " class="lab-text">{{$v->r_type}}</span>
                                        |<span title=" 2室1厅1卫 " class="lab-text">{{$v->r_pattem}}</span>|<span title="2张床" class="lab-text">2张床</span>|<span title="建筑面积108平米" class="lab-text">{{$v->r_area}}平米</span>| <span title="推荐入住 4人" class="lab-text">宜住 {{$v->r_people}}人</span>
                                    </p>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="m-tips-wrap" id="freepickupreturntastevoucher-tip" style="display: none;">
            <div class="tips-content text-description">
                <h2>送体验劵</h2>
                <div class="tips-info">
                    点评超过100字符以上，并上传至少3张相关图片，在七个工作日内审核通过，系统将赠送您体验券，有效期120天。您可登录途家网体验房频道，1:1抵房费预订体验房！详细规则请查看<a href="/UserInfo/TasteVouchers?style=color%3A%23066FD9">我的资产-我的体验券</a>。
                </div>
            </div>
        </div>

        <div class="dn" id="maskWrap" style="width: 486px;"></div>
        <div class="dn" id="orderDayRateDiv" style="width: 484px;"></div>
...
<script type="text/javascript">
    var staticFileRoot = "http://staticfile.tujia.com",
            ...
            TUJIA_CLIENTID = '6561ecdd-45d6-43e7-8a3e-fd315fb90176';
...
<script type="text/javascript" src="http://staticfile.tujia.com/portalsite2/scripts/js_common_foot?v=5e55fe5"></script>
<script type="text/javascript">
