...
<div class="container_24 clearfix" id="orderWrapper">
    ...
    <div class="grid_19" id="order">
        <form action="updateperson" id="UpdateInfo" method="post" onsubmit="return fun()" >
            <div class="wrapper">
                                ...
                                <div class="ud-con">
                                    <div class="clearfix">
                                        <div class="data-result m-fl">
                                            @foreach($data as $v)
                                                <a href="{{URL('')}}"><div href="" class="usp-bg">
                                            ...
                                            <div class="usp-info">
                                                <div class="group-cont">
                                                    <label class="lb-txt">用户名：</label><input id="LoginName" maxlength="15" name="LoginName" type="hidden" value="" />{{$v->u_name}}
                                                </div>
                                                <div class="group-cont">
                                                    <label class="lb-txt">电子邮箱：</label>
                                                    <strong class="lb-info">{{$v->u_email}}</strong>
                                                </div>
                                                <div class="group-cont">
                                        ...
                                        <div class="form">
                                            <div class="control-group ">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <input class="ipt-lg" data-val="false" data-val-length="姓名不能超出5个字符" data-val-length-max="100" id="u_real_name" maxlength="15" name="u_real_name" type="text" value="" onblur="checkname()"/>
                                            ...
                                            <span >
                                                <a onclick="SexChanged(1)" ><input type="radio" id="SexMale" name="u_sex" class="radio-ico active" value="男" checked></a>
                                                <label>男</label>
                                            </span>
                                            <span class="rd-pos">
                                                <a onclick="SexChanged(2)" ><input type="radio"id="SexFeMale" name="u_sex" class="radio-ico " value="女" ></a>
                                                <label>女</label>
                                            </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                <span class="controls-span">出生日期：</span>
                                                <div class="controls">
                                                    <select class="oselectInput" data-val="true" data-val-regex="生日年份必须形如yyyy" data-val-regex-pattern="^\d{4}$" id="Year" name="year" style="display: none;">
                                                    ...
                                                    <input id="Year_Old" name="Year_Old" type="hidden" value="1917" />
                                                    <div id="div_Year" class="u-drop-down" style="display: none;">
                                                        <a href="javascript:;" class="u-dd-result result-sm">
                                                            <input MaxLength="4" id="Year" name="Year" type="text" value="1917" />
                                                            <i class="u-dd-triangle"></i></a>
                                                        <ul id="ul_Year" name='ul_Year' class="u-dd-lis lis-sm" style="overflow-y: scroll; height: 340px;">

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1916</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1917</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1918</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1919</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1920</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1921</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1922</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1923</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1924</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1925</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1926</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1927</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1928</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1929</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1930</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1931</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1932</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1933</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1934</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1935</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1936</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1937</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1938</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1939</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1940</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1941</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1942</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1943</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1944</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1945</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1946</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1947</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1948</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1949</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1950</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1951</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1952</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1953</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1954</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1955</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1956</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1957</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1958</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1959</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1960</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1961</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1962</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1963</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1964</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1965</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1966</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1967</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1968</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1969</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1970</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1971</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1972</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1973</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1974</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1975</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1976</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1977</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1978</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1979</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1980</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1981</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1982</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1983</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1984</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1985</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1986</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1987</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1988</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1989</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1990</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1991</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1992</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1993</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1994</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1995</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1996</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1997</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1998</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">1999</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2000</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2001</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2002</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2003</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2004</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2005</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2006</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2007</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2008</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2009</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2010</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2011</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2012</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2013</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2014</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2015</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthYearChanged(this);" href="javascript:;">2016</a>
                                                            </li>

                                                        </ul>
                                                    </div>
                                                    <em>&nbsp;&nbsp;年&nbsp;&nbsp;</em>
                                                    <select class="oselectInput" data-val="true" data-val-range="生日月份必须是1-12之内的数" data-val-range-max="12" data-val-range-min="1" id="Month" name="month" style="display: none;">
                                                    ...
                                                    <input id="Month_Old" name="Month_Old" type="hidden" value="01" />
                                                    <div id="div_Month" class="u-drop-down" style="display: none;">
                                                        <a href="javascript:;" class="u-dd-result result-sm">
                                                            <input MaxLength="2" id="Month" name="Month" type="text" value="01" /><i class="u-dd-triangle"></i></a>
                                                        <ul id="ul_Month" name="ul_Month" class="u-dd-lis lis-sm">

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">1</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">2</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">3</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">4</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">5</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">6</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">7</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">8</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">9</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">10</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">11</a>
                                                            </li>

                                                            <li>
                                                                <a onclick="birthMonthChanged(this);" href="javascript:;">12</a>
                                                            </li>

                                                        </ul>
                                                    </div>
                                                    <em>&nbsp;&nbsp;月&nbsp;&nbsp;</em>
                                                    <select class="oselectInput" data-val="true" data-val-range="生日日期必须是1-31之内的数" data-val-range-max="31" data-val-range-min="1" id="Date" name="date" style="display: none;"><option selected="selected" value="01">01</option>
                                                        <option value="02">02</option>
                                                        <option value="03">03</option>
                                                        <option value="04">04</option>
                                                        <option value="05">05</option>
                                                    ...
                                                    <input id="Date_Old" name="Date_Old" type="hidden" value="01" />
                                                    <div id="div_Date" class="u-drop-down" style="display: none;">
                                                        <a href="javascript:;" class="u-dd-result result-sm">
                                                            <input MaxLength="2" id="Date" name="Date" type="text" value="01" /><i class="u-dd-triangle"></i></a>
                                                        <ul id="ul_Date" class="u-dd-lis lis-sm" style="overflow-y: scroll; height: 340px;">
                                                        </ul>
                                                    </div>
                                                    <em>&nbsp;&nbsp;日</em>
                                            ...
                                            <div class="control-group city-group">
                                                <span class="controls-span">所在城市：</span>
                                                <div class="controls">
                                                    <select class="oselectInput" id="u_city" name="u_city" style="display: none;"><option value="">请选择城市</option>
                                            ...
                                            <div class="control-group education-group">
                                                <span class="controls-span">教育：</span>
                                                <div class="controls">
                                                    <select class="oselectInput" id="u_study" name="u_study" style="display: none;"><option value="">请选择教育</option>
                                                    ...
                                                    <div id="div_Education" class="u-drop-down" style="display: none;">
                                                        <a href="javascript:;" class="u-dd-result result-lg"><span id="span_Education">请选择</span><i class="u-dd-triangle"></i></a>
                                                        <ul id="ul_Education" name='ul_Education' class="u-dd-lis lis-lg">
                                                            <li>
                                                                <a href="javascript:;" onclick="educationChanged(this)">高中</a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" onclick="educationChanged(this)">大专</a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" onclick="educationChanged(this)">本科</a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" onclick="educationChanged(this)">硕士</a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" onclick="educationChanged(this)">博士</a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" onclick="educationChanged(this)">其他</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="control-group profession-group">
                                                <span class="controls-span">行业：</span>
                                                <div class="controls">
                                                    <select class="oselectInput" data-val="true" data-val-length="职业不能超出50个字符" data-val-length-max="50" id="u_hang" name="u_hang" style="display: none;"><option selected="selected" value="">请选择行业</option>
                                                        ...
                                                        <option value="政府/非盈利机构/其他">政府/非盈利机构/其他</option>
                                                    </select>
                                                </div>
                                            </div>

                                        </div>
                                        <div class="fm-box" style="display: none;">
                                            <label class="lab-box m-fl">想去的城市：</label>
                                            <input id="WantToCity" name="WantToCity" type="hidden" value="" />
                                    ...
                                    <div class="control-group submit-group">
                                        <div class="controls">
                                            ...
                                            <input type="submit" id='sub' value="修改并提交"  /></div>
...
<script>
    ...
    function checkname()
    {
        ...
        var u_real_name=document.getElementById('u_real_name').value;
        var u_real_name1=/^[\x4e00-\x9fa5]+$/;
        if(u_real_name=='')
        {
            document.getElementById('sname').innerHTML='用户名必填';
            document.getElementById('sub').disabled=true;
            return false;
        }
        else if(u_real_name1.test(u_real_name))
        {
            document.getElementById('sname').innerHTML='用户名必须为汉字';
            document.getElementById('sub').disabled=true;
            return false;
        }
        else
