...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="美屋美景，不可辜负" />
    <meta name="keywords" content="来北京，古镇，民宿，阁楼，客栈" />
    <meta name="viewport" />
    <title>美屋美景，不可辜负 - 蜗牛网</title>
    ...
    <div class="w1190">
        ...
        <div class="header-search">
            <div class="form">
                ...
                <span class="log-reg">
                        <a id="btnHeaderLogin" href="https://passport.tujia.com/PortalSite/LoginPage/?srcUrl=http://p.tujia.com/hd/2016jn?code=2016jnp1&amp;srcLocalSite=goSite" class="login">登录</a><span>|</span><a href="https://passport.tujia.com/PortalSite/Register/" class="reg">注册送100元</a>
                </span>
            </div>
        </div>
    </div>
                              ...
                              <a href="{{URL('good?r_id')}}={{$v->r_id}}" target="_blank">{{$v->r_title}}</a>
                                ...
                                <div class="house-datelist">
                                    <p class="house-htladdress">
                                        ...
                                        北京
                                        <a href="javascript:void(0)" ref="http://api.map.baidu.com/staticimage?zoom=15&amp;markers=120.907071,30.949798&amp;width=400&amp;height=400&amp;markerStyles=m, ,&amp;pic=mappic.png" onclick="window.open('http://www.tujia.com/xitang_gongyu/xitang_66971.htm?tabto=map')" class="map-btn">地图</a>
                                    </p>
                                    <p>
