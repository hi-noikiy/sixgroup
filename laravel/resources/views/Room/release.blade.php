...
<div class='header relave'>
			...
			<ul class="nav_R asote nav_right">
            	 <li>
	                <div class="showinfo">
	                    ...
	                    <span class="name" ><?php  $value = session('u_name');
						echo $value;
						?></span></a>
	                    <div class="head_pop">
    ...
    <div class="offmax_no">
        ...
        <p>如有疑问，请联系蜗牛短租客服400-069-6060</p>
...
<body>   
    ...
    <style>     .c322c27{color:#322c27;} 	.lineheight20{line-height:20px;} 	.IM_cancel_bg{z-index:100000; background-color:#000; opacity:0.3; filter:alpha(opacity=30);position:fixed;width:100%;height:100%;top:0;left:0;} 	.IM_cancel_box{width:442px;position:fixed;background-color:#fff;top:50%;left:50%;margin-left:-221px;margin-top:-165px;z-index:100001;padding:30px 70px;box-sizing:border-box;} 	.IM_to_app img{width:121px;height:121px;display:inline-block;vertical-align:middle;} 	.close_imapp{background:url(http://staticnew.mayi.com/resourcesWeb/im/images/close_icon.png) no-repeat center center;background-size:18px 18px;position: absolute;display:inline-block;width: 28px;height: 28px;cursor:pointer;top:5px;right:5px;} 	.close_imapp:hover{background-color:#f2f2f2;border-radius:50%;}     </style> 
</body> 
<script> 	var uid=$('#MAYIUID').val();
	if(uid!='')
	{
...
<link href="http://staticnew.mayi.com/resourcesWeb/css/flow_chart.css" rel="stylesheet"  type="text/css">
	...
	<div class="homes-con" style="margin-top:0px;">
		...
		<form autocomplete="off" name="roomform" action="{{URL('room/message')}}"  method = "post">
		...
		<div class="homes">
			<dl class="homesInfo clearfix">
            	<label class="rentType">
					...
					<p>整套出租（目前蜗牛短租只接受整套出租的房屋，单间床位等其他类型请勿上传）</p>
				</label>
            </dl>
			<!--
			<dl class="homesInfo clearfix">
			...
			<dl class="homesInfo clearfix">
				<dt><span class="fr">附近景点：</span><em class="notNull"></em></dt>
				<dd>
					<select class="largeSelect" name="a_id" >
                        		@foreach($users as  $v)
			...
			<dl class="homesInfo clearfix">
				<dt><span class="fr">房源地址：</span><em class="notNull"></em></dt>
				<dd>
				<label>
				<input type="text" value="" name="stock" class="largeInput fl"></label>
				</dd>
			</dl>
		</div>
