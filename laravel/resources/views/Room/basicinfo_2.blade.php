...
<style>
    ...
    .save{
        background-color:forestgreen;text-align:center;width:150px;height:30px;color: #ffffff;
    }
...
<div class="main">
    ...
    <div class="homes-con" style="margin-top:0px;">
        ...
        <form autocomplete="off" name="detailform" action="{{URL('room/particularse')}}"  method = "post" >
		<input type="hidden" name="_token" value="{{csrf_token()}}"/>
            ...
            <div class="homes">
                <dl class="homesDescribe clearfix">
                    <dt><span class="fr">房源所属区域</span><em class="notNull"></em></dt>
                    <dd>
                       <select class="largeSelect" name="r_district" >
				...
				<dl class="homesDescribe clearfix">
                    <dt><span class="fr">房源主打主题</span><em class="notNull"></em></dt>
                    <dd>
                       <select class="largeSelect" name="r_theme" >
                        		<option value="情侣套餐" >情侣套餐</option>
                        		<option value="欢乐谷" >欢乐谷</option>
                        		<option value="精品订购" >精品订购</option>
                        		<option value="北京美景" >北京美景</option>
                        		<option value="家庭出游房车" >家庭出游房车</option>
...
空调只在卧室有，客厅没有</textarea>
            ...
            <input id="baseSave" type="submit" value="保存,下一步" />
        </form>
    </div>
</div>
<!-- Content END -->
