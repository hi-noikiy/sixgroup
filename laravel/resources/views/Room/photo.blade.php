...
<script type="text/javascript" src="http://staticnew.mayi.com/resourcesWeb/js/jquery-migrate-1.1.1.js?v=20160225"></script>
<script type="text/javascript" src="http://staticnew.mayi.com/resourcesWeb/js/jquery.dragsort-0.5.1.min.js?v=20160225"></script>
<script type="text/javascript" src="http://staticnew.mayi.com/resources/js/layer/layer.min.js"></script>
<script type="text/javascript" src="http://staticnew.mayi.com/resourcesWeb/js/swfupload2/swfupload.js"></script>
<script type="text/javascript" src="http://staticnew.mayi.com/resourcesWeb/js/swfupload2/plugins/swfupload.queue.js?v=20160225"></script>
<script type="text/javascript" src="http://staticnew.mayi.com/resourcesWeb/js/myUpload.js?v=20160225"></script>
<script type="text/javascript" src="http://staticnew.mayi.com/resourcesWeb/js/room_image.js?v=20160225"></script>
<!-- 有道统计所需js
...
<link href="http://staticnew.mayi.com/resourcesWeb/css/flow_chart.css" rel="stylesheet"  type="text/css">
	...
	<div class="homes-con">
		...
		<form autocomplete="off" name="uploadFileForm" action="{{url('room/photos')}}" method="post" enctype="multipart/form-data">
		<input type="hidden" name="_token" value="{{csrf_token()}}"/>
					<table>
				<tr>
					<td>上传图片</td>
					<td><input type="file" name="roomImg[]" id="" multiple  /></td>
				</tr>
			</table>
